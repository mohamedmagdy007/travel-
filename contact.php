        ...
        <div class="col-lg-6 contact-left">
          <div class="partners">
            ...
            <div class="hours">
              ...
              <p> <a href="mailto:mohammed.mo7864@gmail.com‏">
                  mohammed.mo7864@gmail.com‏
                </a></p>
        ...
        <div class="col-lg-6 mt-lg-0 mt-5 contact-right">
          <form method="post" class="signin-form">
            ...
            <div class="text-right">
              <button type="submit" name="sendemail" class="btn btn-style btn-primary">Send Message</button>
            </div>
            ...
            if (isset($_POST["sendemail"])) {
              ...
              $mail->setFrom("mohammed.mo7864@gmail.com");

              $mail->addAddress("mohammed.mo7864@gmail.com");
              ...
              if (!$mail->send()) {
                ...
                echo ("<div class='alert alert-success'> Message Sent! Thank you for contacting us.</div>");
              }
            }
