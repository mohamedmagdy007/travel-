      ...
      <a class="navbar-brand" href="#index.html">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="about.html">Department</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="about.html">About</a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="modal" aria-pressed="false" data-target="#exampleModal1"> <span class="fa fa-sign-in"></span> Register</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="modal" aria-pressed="false" data-target="#exampleModal"><span class="fa fa-lock"></span> Sign in</a>
            </li>
          </ul>
        </div>
        <!-- toggle switch for light and dark theme -->
  ...
  <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
    <div class="container">
      ...
      <ul class="breadcrumbs-custom-path mt-2">
        ...
        <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Your shopping cart </li>
      </ul>
    </div>
  </div>
</section>
...
<div class="container mt-5 mb-5">
  <div class="row">
    ...
    include_once "classes/Database.php";
    $db = new Database();
    $rs = $db->GetData("select * from booking where userID='" . $_SESSION["id"] . "'");
      ...
      <div class="col-12 col-md-6 col-lg-4 ">
        <div class="card mb-3 " style="height: 500px;">
          <div class="modal-open zs-enabled">
            ...
            <div class="rome">
              <a href="deletebook.php?pno=<?php echo $row1["bookingNo"] ?>" title="remove"> <i class="fas fa-times"></i></a>
            </div>
          </div>
          <div class="card-body">
            ...
            <div class="row justify-content-around">
              <p> <span class="font-weight-bold">Number of seats :</span><?php echo $row1["numberOfSeats"] ?> </p>
              <p> <span class="font-weight-bold">Number childent : </span> <?php echo $row1["numberChildent"] ?> </p>
            </div>
            <div class="pr-2 text-right">
              <p>
                ...
                </i> <small> Total</small> <span style="color:#d8207a ; font-weight: bold;">$ <?php echo $row1["total"] ?> </span>
              </p>
            </div>
          </div>
