        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="#travels">Destinations</a>
            </li>
            <li class="nav-item">
      ...
      <a class="navbar-brand" href="#index.html">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="modal" aria-pressed="false"
               data-target="#exampleModal1" > <span class="fa fa-sign-in"></span> Register</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="modal" aria-pressed="false"
                data-target="#exampleModal" ><span class="fa fa-lock" ></span> Sign in</a>
            </li>
          </ul>
        </div>
